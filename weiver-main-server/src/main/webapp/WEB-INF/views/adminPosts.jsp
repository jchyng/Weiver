...
<head>
  ...
  <style>
    ...
    .badge-review { background: rgba(190,18,60,0.15); color: #BE123C; padding: 2px 8px; border-radius: 6px; font-size: 11px; font-weight: 700; }
    .badge-chat { background: rgba(148,163,184,0.15); color: #94A3B8; padding: 2px 8px; border-radius: 6px; font-size: 11px; font-weight: 700; }
  </style>
</head>
