...
public class AdminControllerTest {
    ...
    private CrawlingService crawlingService = mock(CrawlingService.class);
    ...
    public void 관리자문의_페이지가_잘넘어온다() {
        ...
        AdminController controller = new AdminController(adminService, crawlingStatus, crawlingService);
